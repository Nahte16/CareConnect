...
public class Database  extends SQLiteOpenHelper {
    ...
    public int checkAppointmentExists(String username, String fullname, String address, String date,String time){
        int result = 0;
